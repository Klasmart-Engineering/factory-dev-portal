...
export default function SubscriptionsApiClientProvider (props: Props) {
    ...
    const SUBSCRIPTIONS_ENDPOINT = process.env.SUBSCRIPTIONS_ENDPOINT;
    const SUBSCRIPTIONS_REQUEST_RETRY_COUNT_MAX = +(process.env.SUBSCRIPTIONS_REQUEST_RETRY_COUNT_MAX ?? 1);
